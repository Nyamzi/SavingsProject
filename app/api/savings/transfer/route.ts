  ...
  try {
    ...
    await prisma.savings.update({
      ...
      data: {
        ...
        amount: { increment: amount }, // Add to savings
      },
    })
    ...
    await prisma.transaction.create({
      data: {
        userId,
        type: 'DEPOSIT', // Transfer to savings is like a deposit to savings
        amount,
        description: validatedData.description || 'Transfer to savings',
      },
    })
